...
def generate_launch_description():
    ...
    #         "controllers_file",
    #         default_value="trajectory_control.yaml",
    #         # default_value="ur5_gazebo_control.yaml",
    ...
    load_joint_state_controller = ExecuteProcess(
        cmd=['ros2', 'control', 'load_controller', '--set-state', 'state', 'joint_state_broadcaster'],
        output='screen'
    )

    load_arm_controller = ExecuteProcess(
        cmd=['ros2', 'control', 'load_controller', '--set-state', 'state', 'arm_controller'],
        output='screen'
    )
